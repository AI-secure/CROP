...
if __name__=='__main__':
    ...
    prefix = f'{args.gym_id}_{args.dqn_type}_m-{args.m}_sigma-{args.sigma}_attack_eps-{args.epsilon}'
    ...
    if args.load_checkpoint:
        ...
        q_network.network.load_state_dict(
    ...
    for global_step in range(args.total_timesteps):
        ...
        state = state / 255
        state = attack(lo_act, state, attack_config=None, epsilon=args.epsilon, network_type=args.dqn_type, smooth_type='local')
    ...
    filename = f'{train_log[:-4]}_attacked-reward.pt'

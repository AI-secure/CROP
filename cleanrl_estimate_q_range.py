...
from est_range import EstRange
...
if __name__=='__main__':
    ...
    prefix = f'{args.gym_id}_{args.dqn_type}_m-{args.m}_sigma-{args.sigma}_est'
    ...
    est_range = EstRange(logger.log, env.observation_space.shape, q_network, q_network.forward, 
                         args.m, args.sigma)
    ...
    for global_step in range(args.total_timesteps):
        ...
        action = est_range.forward(state)[0]
        ...
        obs = next_obs
        if this_episode_frame_idx == args.max_frames_per_episode:
        ...
        if done:
            ...
            q_range_file = f'{train_log[:-4]}_q-range-{num_episodes}.pt'
            est_range.save(q_range_file)
